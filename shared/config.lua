...
Config.PenalCode = {
    ...
    [2] = {
        ...
        [10] = {title = 'Store Robbery', class = 'Felony', id = 'P.C. 2010', months = 25, fine = 2000, color = 'green', description = 'The action of taking property unlawfully from a person or store by force or threat of force.'},
        [11] = {title = 'Accessory to Store Robbery', class = 'Felony', id = 'P.C. 2011', months = 12, fine = 1000, color = 'green', description = 'Being present and or participating in the act of parent charge'},
        [12] = {title = 'Attempted Store Robbery', class = 'Felony', id = 'P.C. 2012', months = 20, fine = 1000, color = 'green', description = 'The action of attempting property unlawfully from a person or store by force or threat of force.'},
        [13] = {title = 'Bank Robbery', class = 'Felony', id = 'P.C. 2013', months = 25, fine = 6000, color = 'green', description = 'The action of taking property unlawfully from a person or Bank by force or threat of force.'},
        [14] = {title = 'Accessory to Bank Robbery', class = 'Felony', id = 'P.C. 2014', months = 12, fine = 2500, color = 'green', description = 'Being present and or participating in the act of parent charge'},
        [15] = {title = 'Attempted Bank Robbery', class = 'Felony', id = 'P.C. 2015', months = 20, fine = 3500, color = 'green', description = 'The action of attempting property unlawfully from a person or Bank by force or threat of force.'},
        [16] = {title = 'Jewellery Robbery', class = 'Felony', id = 'P.C. 2016', months = 25, fine = 5000, color = 'green', description = 'The action of taking property unlawfully from a person or Jewellery Store by force or threat of force.'},
        [17] = {title = 'Accessory to Jewellery Robbery', class = 'Felony', id = 'P.C. 2017', months = 12, fine = 2500, color = 'green', description = 'Being present and or participating in the act of parent charge'},
        [18] = {title = 'Attempted Jewellery Robbery', class = 'Felony', id = 'P.C. 2018', months = 20, fine = 4500, color = 'green', description = 'The action of attempting property unlawfully from a person or Jewellery Store by force or threat of force.'},
        [19] = {title = 'House Robbery', class = 'Felony', id = 'P.C. 2019', months = 25, fine = 4000, color = 'green', description = 'The action of taking property unlawfully from a person or House by force or threat of force.'},
        [20] = {title = 'Accessory to House Robbery', class = 'Felony', id = 'P.C. 2020', months = 12, fine = 2500, color = 'green', description = 'Being present and or participating in the act of parent charge'},
        [21] = {title = 'Attempted House Robbery', class = 'Felony', id = 'P.C. 2021', months = 20, fine = 3500, color = 'green', description = 'The action of attempting property unlawfully from a person or House by force or threat of force.'},
        [22] = {title = 'Armed Robbery', class = 'Felony', id = 'P.C. 2022', months = 30, fine = 3000, color = 'orange', description = 'The action of taking property unlawfully from a person or place by force or threat of force while armed.'},
        [23] = {title = 'Accessory to Armed Robbery', class = 'Felony', id = 'P.C. 2023', months = 15, fine = 1500, color = 'orange', description = 'Being present and or participating in the act of parent charge'},
        [24] = {title = 'Attempted Armed Robbery', class = 'Felony', id = 'P.C. 2024', months = 25, fine = 1500, color = 'orange', description = 'The action of attempting property unlawfully from a person or place by force or threat of force while armed.'},
        [25] = {title = 'Armed Store Robbery', class = 'Felony', id = 'P.C. 2025', months = 30, fine = 3000, color = 'orange', description = 'The action of taking property unlawfully from a person or store by force or threat of force while armed.'},
        [26] = {title = 'Accessory to Armed Store Robbery', class = 'Felony', id = 'P.C. 2026', months = 15, fine = 1500, color = 'orange', description = 'Being present and or participating in the act of parent charge'},
        [27] = {title = 'Attempted Armed Store Robbery', class = 'Felony', id = 'P.C. 2027', months = 25, fine = 1500, color = 'orange', description = 'The action of attempting property unlawfully from a person or store by force or threat of force while armed.'},
        [28] = {title = 'Armed Bank Robbery', class = 'Felony', id = 'P.C. 2028', months = 30, fine = 7000, color = 'orange', description = 'The action of taking property unlawfully from a person or Bank by force or threat of force while armed.'},
        [29] = {title = 'Accessory to Armed Bank Robbery', class = 'Felony', id = 'P.C. 2029', months = 15, fine = 4500, color = 'orange', description = 'Being present and or participating in the act of parent charge'},
        [30] = {title = 'Attempted Armed Bank Robbery', class = 'Felony', id = 'P.C. 2030', months = 25, fine = 4000, color = 'orange', description = 'The action of attempting property unlawfully from a person or Bank by force or threat of force while armed.'},
        [31] = {title = 'Armed Jewellery Robbery', class = 'Felony', id = 'P.C. 2031', months = 30, fine = 6000, color = 'orange', description = 'The action of taking property unlawfully from a person or Jewellery Store by force or threat of force while armed.'},
        [32] = {title = 'Accessory to Armed Jewellery Robbery', class = 'Felony', id = 'P.C. 2032', months = 15, fine = 3500, color = 'orange', description = 'Being present and or participating in the act of parent charge'},
        [33] = {title = 'Attempted Armed Jewellery Robbery', class = 'Felony', id = 'P.C. 2033', months = 25, fine = 4500, color = 'orange', description = 'The action of attempting property unlawfully from a person or Jewellery Store by force or threat of force while armed.'},
        [34] = {title = 'Armed House Robbery', class = 'Felony', id = 'P.C. 2034', months = 30, fine = 5000, color = 'orange', description = 'The action of taking property unlawfully from a person or House by force or threat of force while armed.'},
        [35] = {title = 'Accessory to Armed House Robbery', class = 'Felony', id = 'P.C. 2035', months = 15, fine = 3500, color = 'orange', description = 'Being present and or participating in the act of parent charge'},
        [36] = {title = 'Attempted Armed House Robbery', class = 'Felony', id = 'P.C. 2036', months = 25, fine = 4500, color = 'orange', description = 'The action of attempting property unlawfully from a person or House by force or threat of force while armed.'},        
        [37] = {title = 'Grand Larceny', class = 'Felony', id = 'P.C. 2037', months = 45, fine = 7500, color = 'orange', description = 'Theft of personal property having a value above a legally specified amount.'},
        [38] = {title = 'Leaving Without Paying', class = 'Infraction', id = 'P.C. 2038', months = 0, fine = 500, color = 'green', description = 'The act of leaving an establishment without paying for provided service'},
        [39] = {title = 'Possession of Nonlegal Currency', class = 'Misdemeanor', id = 'P.C. 2039', months = 10, fine = 750, color = 'green', description = 'Being in possession of stolen currency'},
        [40] = {title = 'Possession of Government-Issued Items', class = 'Misdemeanor', id = 'P.C. 2040', months = 15, fine = 1000, color = 'green', description = 'Being in possession of Items only acquireable by government employees'},
        [41] = {title = 'Possession of Items Used in the Commission of a Crime', class = 'Misdemeanor', id = 'P.C. 2041', months = 10, fine = 500, color = 'green', description = 'Being in possession of Items that were previously used to commit crimes'},
        [42] = {title = 'Sale of Items Used in the Commission of a Crime', class = 'Felony', id = 'P.C. 2042', months = 15, fine = 1000, color = 'orange', description = 'The act of selling items that were previously used to commit crimes'},
        [43] = {title = 'Theft of an Aircraft', class = 'Felony', id = 'P.C. 2043', months = 20, fine = 1000, color = 'green', description = 'The act of stealing an aircraft'},
    },
    [3] = {
